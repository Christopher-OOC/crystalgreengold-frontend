...
export const MemberManagement: React.FC<MemberManagementProps> = ({
    ...
    return (
      <div className="space-y-8 max-w-5xl mx-auto pb-12">
        <button
          ...
          className="flex items-center space-x-2 text-slate-500 hover:text-orange-500 transition-colors font-bold text-sm group"
        >
          <ArrowLeft
            size={16}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <Card className="lg:col-span-1 p-8 space-y-6 border-none shadow-2xl h-fit">
            <div className="text-center space-y-4">
              <div className="w-24 h-24 bg-orange-500 rounded-3xl flex items-center justify-center mx-auto shadow-lg shadow-orange-500/20">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex items-center justify-end space-x-4">
              ...
              <Button
                ...
                className="bg-orange-500 text-white hover:bg-orange-600 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all flex items-center space-x-2"
              >
        ...
        <AnimatePresence>
          {showActionToast && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              className="fixed bottom-8 right-8 z-50 flex items-center space-x-3 bg-slate-900 text-white px-8 py-4 rounded-2xl shadow-2xl font-black uppercase tracking-widest text-xs"
            >
        ...
        return (
          <div className="space-y-6">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium text-sm"
                  />
                </div>
                <div className="flex flex-wrap items-center gap-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <select
                      ...
                      className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-xs font-black uppercase outline-none cursor-pointer"
                    >
            ...
            <Card noPadding className="overflow-hidden border-none shadow-2xl">
              {isLoading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse min-w-[1200px]">
                    <thead>
                      <tr className="bg-orange-50/50 dark:bg-white/5 border-b border-orange-100 dark:border-white/5">
                        <th className="px-4 py-4 text-[10px] font-black text-orange-600 uppercase tracking-widest">
                          S/N
                        </th>
                        <th className="px-4 py-4 text-[10px] font-black text-orange-600 uppercase tracking-widest">
                          NAME
                        ...
                        <th className="px-4 py-4 text-[10px] font-black text-orange-600 uppercase tracking-widest text-center">
                          STATUS
                        </th>
                        <th className="px-4 py-4 text-[10px] font-black text-orange-600 uppercase tracking-widest text-center">
                          ACTIONS
                          ...
                          >
                            ...
                            <td className="px-4 py-4 text-center">
                                  ...
                                  disabled={isImpersonating}
	                                className="p-2 bg-orange-500/10 text-orange-500 hover:bg-orange-500 hover:text-white rounded-lg transition-all"
	                                title="Login as user"
	                              >
              ...
              <div className="px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-50 dark:border-white/5 bg-slate-50/30 dark:bg-white/[0.01]">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <select
                      ...
                      className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-lg px-3 py-1.5 text-[10px] font-black outline-none cursor-pointer"
                    >
                  ...
                  <div className="flex items-center space-x-1">
                    <button
                      ...
                      className="p-2 text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-all disabled:opacity-30"
                    >
                      <ChevronLeft size={16} />
                    </button>
                    {Array.from(
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-12">
      ...
      <div className="flex items-center justify-center space-x-2 bg-white dark:bg-slate-900 p-1.5 rounded-2xl shadow-sm w-fit mx-auto border border-slate-100 dark:border-white/5">
        {tabs.map((tab) => (
          <button
            key={tab.id}
