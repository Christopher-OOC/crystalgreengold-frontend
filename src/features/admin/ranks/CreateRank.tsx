  ...
  return (
    <div className="max-w-2xl mx-auto pb-12 space-y-6 relative">
      ...
      <div className="flex items-center space-x-4">
        <button onClick={onBack} disabled={isLoading} className="p-2 hover:bg-emerald-50 dark:hover:bg-white/5 rounded-full transition-colors disabled:opacity-50">
      ...
      <Card className="p-8 md:p-10 border-none shadow-2xl space-y-8">
        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-emerald-400 uppercase tracking-widest">Rank Name *</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-emerald-400 uppercase tracking-widest">Qualifying BV *</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-emerald-400 uppercase tracking-widest">Rank Value *</label>
              <input type="number" name="rankValue" value={formData.rankValue} onChange={handleChange}
                placeholder="1" disabled={isLoading}
                className="w-full bg-white dark:bg-emerald-950 border border-emerald-100 dark:border-white/10 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-amber-400/20 focus:border-amber-400 transition-all font-medium disabled:opacity-50" />
              <p className="text-[10px] text-emerald-400 italic">Higher = more senior</p>
            </div>
          </div>
        </div>
