    ...
    <div className="space-y-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all w-64"
            />
          </div>
          <button
            onClick={() => setShowFilters(!showFilters)}
            className={`p-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl transition-colors ${
              showFilters
      ...
      {showFilters && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="bg-white dark:bg-slate-900 rounded-xl p-4 border border-slate-200 dark:border-white/10 shadow-sm"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredAndSortedStores.map((store, i) => (
            ...
            >
              <Card
                noPadding
                className="group cursor-pointer overflow-hidden border-none shadow-sm hover:shadow-2xl transition-all duration-500 bg-white dark:bg-slate-900"
                onClick={() =>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md px-3 py-1 rounded-full flex items-center space-x-1 shadow-lg">
