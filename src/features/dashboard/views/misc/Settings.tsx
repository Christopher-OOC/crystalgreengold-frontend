          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 flex items-center justify-between">
                ...
                >
                  <div
                    className={`absolute top-1 left-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 ${receivePayment ? "translate-x-7" : "translate-x-0"}`}
                  />
                  <span className="absolute right-2 top-1.5 text-[8px] font-black text-white uppercase">
                    {receivePayment ? "ON" : ""}
                  </span>
                  <span className="absolute left-2 top-1.5 text-[8px] font-black text-white uppercase">
                    {!receivePayment ? "OFF" : ""}
                  </span>
                </button>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                {
                  label: "Monthly Left PV",
                  value: String(dashboardData?.monthlyLeftPv ?? 0),
                },
                {
                  label: "Monthly Right PV",
                  value: String(dashboardData?.monthlyRightPv ?? 0),
                },
              ].map((stat, i) => (
                <div
                  key={i}
                  className="p-5 bg-amber-50/50 dark:bg-amber-400/5 rounded-2xl border border-amber-100 dark:border-amber-400/10"
                >
                  <p className="text-[10px] font-black text-amber-400 dark:text-amber-400 uppercase tracking-widest mb-2">
                    {stat.label}
                  </p>
